...
- **Notes:** Requires Domination control points. See the full [Domination guide](../domination.md).
...
- **Notes:** Requires `headhunters_receptacle` entities. See the full [Head Hunters guide](../headhunters.md).
